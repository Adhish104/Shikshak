...
<div>
	<div>
		<div class="topnav">
			<a class="navlink" href="home.php" style="margin: 0px 0px 0px 100px;">Students</a>
			  	...
			  	<div class="itemrow">
					...
					<div class="itemrow">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="None">None</option>
							  <option value="Nawas Shareef University">Nawas Shareef University</option>
					...
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 01/05/2023" value="'.$deadline.'">'; ?></p>
				  			</div>
				  	</div>
