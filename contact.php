        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Cochin University of Science and Technology</div>
              <div class="text-two">Ernakulam City,District Ernakulam,Kerela,INDIA</div>
            </div>
            ...
            <div class="email details">
              ...
              <br>
              <div class="text-one">Kavya Raj</div>
              <div class="text-two">kavyaraj@gmail.com</div>
              <br>
              <div class="text-one">Adhish Pratap</div>
              <div class="text-two">adhish4@gmail.com</div>
            </div>
          </div>
          ...
          <form action="mailto:kavyaraj@gmail.com,@gmail.com" enctype="text/plain" method="post">
            <div class="input-box">
