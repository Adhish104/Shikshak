	...
	<div class="nbody" >
        ...
        <div class="Search">
            ...
            <div class="s_contents">
                ...
                <div class="lc">
                    <p>Location</p>
                    <?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Ernakulam,Kerela ">'; ?>
                </div>
                <div class="uni">
                    <p>University</p>
                    <select name="p_university" style="width: 180px;">
                      ...
                      <option value="APJ Abdul Kalam Univesity">APJ Abdul Kalam Univesity</option>
                    </select>
                </div>
